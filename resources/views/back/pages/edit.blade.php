            ...
            <div class="col-md-10 col-md-offset-1">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        {!! Form::model($page, array("route"=>array('admin.pages.update', $page->id), "role"=>"form", "method"=>"PATCH")) !!}
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::select("template_id",$template->lists("display", "id"),$page->template_id,array("class"=>"form-control")) !!}
